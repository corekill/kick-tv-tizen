...
Lite zachovává vyhledávání, historii se stavem LIVE/OFFLINE, automatickou kontrolu offline kanálu, Samsung AVPlay a živý read-only chat. Kvůli výkonu starších televizí nepoužívá výběr kvality, obrázkové emotikony, 7TV ani nastavitelné chatové overlaye.
